...
\input{pages/objetivos}
\input{pages/introduccion}

\input{pages/origenes-kanban}
\input{pages/principios-kanban}
\input{pages/tablero-kanban}
\input{pages/flujo-kanban}
\input{pages/roles-kanban}
\input{pages/implementacion-kanban}
\input{pages/ventajas-desventajas-kanban}
\input{pages/comparacion-otras-metodologias}
\input{pages/casos-estudio}

\input{pages/conclusiones}
\input{pages/glosario}
