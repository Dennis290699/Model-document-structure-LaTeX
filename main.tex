...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textit{Instalación, Configuración y Ejecución de Hadoop usando Docker}}
\fancyhead[R]{\thepage}
\fancyfoot[C]{\textit{Cátedra - Taller I}}
...
\input{pages/marco-teorico}
\input{pages/requerimientos}
\input{pages/metodologia}
\input{pages/desarrollo}
