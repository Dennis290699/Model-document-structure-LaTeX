...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textit{Programación Funcional Reactiva en Java}}
\fancyhead[R]{\thepage}
\fancyfoot[C]{\textit{Programación Avanzada III}}
...
\input{pages/memoizacion}
\input{pages/IPR}
\input{pages/observables}
\input{pages/operadores}
